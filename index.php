...
//            mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
    ...
    <nav class="navbar navbar-light bg-ligh">
        <div class="container-fluid justify-content ">
            <div>
                <button class="btn btn-outline-info mr-2 show but-nav" type="button" title="Filter" data-toggle="modal" data-target="#filters">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-filter" viewBox="0 0 16 16">
                        <path d="M6 10.5a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm-2-3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
                    </svg>
                </button>

                <button class="btn btn-outline-info mr-2 but-nav" type="submit" name="my_button" title="Random" data-toggle="modal" data-target="#random" id="icon_events_header">
            ...
            <div class="modal-content card-font">
                ...
                <div class="modal-body">
                    <form id="add_form" role="form" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn add_button center">Add movie</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container" >
        <div class="row " id="Container">
            <div class="backNav hidding">
                <button class="btn btn-outline-info mr-2 hide but-nav">
                    <a href="index.php" class="but-nav">
